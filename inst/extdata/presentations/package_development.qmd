...
| File | Issue | Fix |
|------|-------|-----|
| model_description.R | Duplicate "CapeCod" condition | Changed to "Chain" |
| berquist.R | Wrong error message text | "(size - 1)" → "(size + 1)" |
| berquist.R | Dead code (trd = 0.01) | Commented with note |
