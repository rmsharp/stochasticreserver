...
**stochasticreserver** is an R package providing a flexible framework for
stochastic reserving models used in actuarial loss reserving. The package
implements maximum likelihood estimators for five common reserving methods,
allowing direct handling of non-linear models without transformation.

Based on Roger Hayne's paper "A Flexible Framework for Stochastic Reserving
Models" published in *Variance* journal.
