...
g - Assumed loss emergence model, a function of the parameters a. Note g
must be matrix-valued with size rows and size columns
...
flexible enough to handle both. Here g_obj is the Berquist-Sherman
incremental severity model
